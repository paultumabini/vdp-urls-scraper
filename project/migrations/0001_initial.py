# Generated by Django 6.0.2 on 2026-02-22 00:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('web_provider', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='web_provider', to='project.webprovider')),
            ],
        ),
        migrations.CreateModel(
            name='TargetSite',
            fields=[
                ('status', models.CharField(choices=[('Active', 'Active'), ('Inactive', 'Inactive'), ('Pending', 'Pending'), ('Failed', 'Failed'), ('Paused', 'Paused')], default='Pending', max_length=10)),
