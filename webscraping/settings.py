...
SECRET_KEY = 'django-insecure-&t^s6g^jbn^j5g=e6fp5es4hb=ofcyg7^s)575%6(s6*d#s8w#'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework.authtoken',  # display token section at admin
    # django cors policy
    'corsheaders',
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        # 'rest_framework.renderers.BrowsableAPIRenderer',  # This is what enables the browsable API
    ],
